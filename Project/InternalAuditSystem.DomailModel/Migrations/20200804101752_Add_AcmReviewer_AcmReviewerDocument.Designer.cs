...
namespace InternalAuditSystem.DomailModel.Migrations
{
    ...
    [Migration("20200804101752_Add_AcmReviewer_AcmReviewerDocument")]
    partial class Add_AcmReviewer_AcmReviewerDocument
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ACMPresentationModels.ACMDocument", b =>
                {
                    ...
                    b.Property<Guid?>("ACMReportMappingId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ACMPresentationModels.ACMReviewer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.PrimaryGeographicalArea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ObservationManagement.Observation", b =>
                {
                    ...
                    b.Property<int>("ObservationListStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ReportManagement.ReportObservationReviewer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ReportManagement.ReportObservationsDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ReportManagement.ReportObservationsMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.UserModels.User", b =>
                {
                    ...
                    b.Property<Guid?>("CurrentSelectedEntityId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.ACMPresentationModels.ACMReportDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ACMReportDetail");
                });

            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.ACMPresentationModels.ACMReviewerDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AcmReportDetailId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AcmReviewerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AcmReportDetailId");

                    b.HasIndex("AcmReviewerId");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("UpdatedBy");

                    b.ToTable("ACMReviewerDocument");
                });

            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.ACMPresentationModels.ACMTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.ObservationManagement.ObservationTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ObservationTable");
                });

            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.ReportManagement.ReportObservationTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ReportObservationTable");
                });
            ...
            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.StrategicAnalysisModels.UserResponse", b =>
                {
                    ...
                    b.Property<bool>("IsDetailAndEstimatedValueOfOpportunity")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsEmailAttachements")
                        .HasColumnType("boolean");
                    ...
                    b.Property<Guid?>("ParentFileUploadUserResponseId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("SamplingResponseStatus")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ParentFileUploadUserResponseId");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ACMPresentationModels.ACMDocument", b =>
                {
                    ...
                    b.HasOne("InternalAuditSystem.DomailModel.Models.ACMPresentationModels.ACMReportMapping", "ACMReportMapping")
                        .WithMany()
                        .HasForeignKey("ACMReportMappingId");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.ACMPresentationModels.ACMReportMapping", b =>
                {
                    ...
                    b.HasOne("InternalAuditSystem.DomainModel.Models.ACMPresentationModels.ACMReportDetail", "ACMReportDetail")
                        .WithMany()
                        .HasForeignKey("AcmReportId");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.AuditPlanModels.AuditPlan", b =>
                {
                    ...
                    b.HasOne("InternalAuditSystem.DomailModel.Models.AuditPlanModels.AuditPlan", "ParentAuditPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.AuditableEntity", b =>
                {
                    ...
                    b.HasOne("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.AuditableEntity", "ParentEntity")
                        .WithMany()
                        .HasForeignKey("ParentEntityId");

                    b.HasOne("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.EntityCategory", "EntityCategory")
                        .WithMany()
                        .HasForeignKey("SelectedCategoryId");

                    b.HasOne("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.EntityType", "EntityType")
                        .WithMany()
            ...
            modelBuilder.Entity("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.EntityRelationMapping", b =>
                {
                    ...
                    b.HasOne("InternalAuditSystem.DomailModel.Models.AuditableEntityModels.AuditableEntity", "RelatedAuditableEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.ACMPresentationModels.ACMReviewerDocument", b =>
                {
                    b.HasOne("InternalAuditSystem.DomainModel.Models.ACMPresentationModels.ACMReportDetail", "ACMReportDetail")
                        .WithMany()
                        .HasForeignKey("AcmReportDetailId");

                    b.HasOne("InternalAuditSystem.DomailModel.Models.ACMPresentationModels.ACMReviewer", "ACMReviewer")
                        .WithMany()
                        .HasForeignKey("AcmReviewerId");
            ...
            modelBuilder.Entity("InternalAuditSystem.DomainModel.Models.StrategicAnalysisModels.UserResponse", b =>
                {
                    ...
                    b.HasOne("InternalAuditSystem.DomainModel.Models.StrategicAnalysisModels.UserResponse", "ParentFileUploadUserResponse")
                        .WithMany()
                        .HasForeignKey("ParentFileUploadUserResponseId");
